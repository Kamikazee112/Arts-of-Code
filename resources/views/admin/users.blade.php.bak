...
@section('content')
    <div class="max-w-[1000px] mx-auto">
        <div class="flex justify-between items-center mb-8">
            <h1 class="text-[28px] font-medium text-[var(--text)]">Manage المستخدمين</h1>
        ...
        <div class="grid md:grid-cols-3 gap-6 mb-8">
            <div class="card p-6">
                ...
                <div class="text-[14px] text-[var(--muted)]">Total المستخدمين</div>
            </div>
            <div class="card p-6">
            ...
            <div class="card p-6">
                ...
                <div class="text-[14px] text-[var(--muted)]">Regular المستخدمين</div>
            </div>
        </div>
        ...
        <div class="mb-6">
            <form method="GET" action="/admin/users" class="flex gap-2">
                <input type="text" name="search" value="{{ $search ?? '' }}"
                    placeholder="بحث users by username or email..." class="input flex-1">
        ...
        <div class="card">
            <div class="p-4 border-b border-[var(--border)]">
                <h2 class="text-[18px] font-medium text-[var(--text)]">All المستخدمين</h2>
            </div>
