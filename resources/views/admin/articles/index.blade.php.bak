...
<div>
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        <h1 class="text-[22px] font-bold text-[var(--text)] tracking-tight">Articles</h1>
                ...
                <table class="w-full">
                    <thead>
                        <tr class="border-b border-[var(--border)] bg-[var(--surface-2)]">
                            ...
                            <th class="text-left py-3 px-4 text-[11px] font-bold text-[var(--muted)] uppercase tracking-wider hidden md:table-cell">Submitted</th>
                            ...
                            <tr class="border-b border-[var(--border)] last:border-0 hover:bg-[var(--surface-2)] transition-colors">
                                ...
                                <td class="py-3.5 px-4">
                                    <div class="action-group">
                                        ...
                                        <!-- Edit -->
                                        <a href="/admin/articles/{{ $article->id }}/edit" class="btn-sm btn-sm-edit">Edit</a>
