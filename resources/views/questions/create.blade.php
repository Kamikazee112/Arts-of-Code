...
@section('title', 'Create Question - Arts Of Code')

@section('content')
<div class="max-w-[800px] mx-auto">
    <!-- Page Title -->
    <h1 class="text-[22px] font-medium text-[var(--text)] mb-8">Create Question</h1>
    ...
    <div class="card p-6">
        ...
        <form method="POST" action="/questions" id="question-form">
            @csrf
            ...
            <!-- MCQ Options -->
            <div id="mcq-options" class="mb-4" style="display: {{ old('type') == 'mcq' ? 'block' : 'none' }};">
            ...
            <!-- True/False Answer -->
            <div id="true-false-options" class="mb-4" style="display: {{ old('type') == 'true_false' ? 'block' : 'none' }};">
                ...
                <div class="flex gap-4">
                    <label class="flex items-center gap-2">
                        <input
                            ...
                            name="correct_answer"
                            value="1"
                            {{ old('correct_answer', '1') == '1' ? 'checked' : '' }}
                            class="w-4 h-4"
                        >
                        <span>True</span>
                    </label>
                    <label class="flex items-center gap-2">
                        <input
                            ...
                            name="correct_answer"
                            value="0"
                            {{ old('correct_answer', '1') == '0' ? 'checked' : '' }}
                            class="w-4 h-4"
                        >
                        <span>False</span>
                    </label>
