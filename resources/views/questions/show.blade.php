...
<div class="max-w-[800px] mx-auto">
    <!-- Back Button -->
    <a href="/questions" class="text-sm text-[var(--muted)] hover:text-[var(--accent)] transition-colors mb-6 inline-block">
        ← Back to Questions
    </a>
    ...
    <div class="card p-6 mb-6">
        <div class="flex justify-between items-start mb-4">
            ...
            <div class="flex gap-2">
                <a href="/questions/{{ $question->id }}/edit" class="btn-outline text-sm">
                    Edit
                </a>
        ...
        <div class="card p-6">
            ...
            <div class="space-y-3">
                @foreach($question->options as $option)
                    <div class="flex items-center gap-3 p-3 rounded-lg {{ $option->is_correct ? 'bg-green-50 border border-green-200' : 'bg-[var(--bg)]' }}">
                        <div class="w-6 h-6 rounded-full flex items-center justify-center {{ $option->is_correct ? 'bg-green-500 text-white' : 'bg-gray-200 text-gray-600' }}">
