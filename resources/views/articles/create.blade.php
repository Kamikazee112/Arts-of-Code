...
<div class="max-w-[800px] mx-auto">
    <!-- Page Title -->
    <div class="mb-8">
        <h1 class="text-[22px] font-medium text-[var(--text)]">Write Article</h1>
        <p class="text-[13px] text-[var(--muted)] mt-2">
            Your article will be reviewed by an admin before it appears publicly.
        </p>
    </div>
    ...
    <form method="POST" action="/articles">
        ...
        <div class="flex justify-between items-center">
            <a href="/articles" class="text-[var(--muted)] hover:text-[var(--text)] transition-colors">
                Cancel
            </a>
