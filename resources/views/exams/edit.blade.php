...
<div class="max-w-[850px] mx-auto animate-fade-up">
    ...
    <div class="mb-8">
        ...
        <div class="flex items-center gap-3">
            ...
            <h1 class="text-[26px] font-extrabold text-[var(--text)] tracking-tight">Edit Quiz: <span class="text-[var(--accent)]">{{ $exam->title }}</span></h1>
        </div>
    </div>
    ...
    <div class="card p-8 md:p-10 shadow-lg relative overflow-hidden bg-white">
        ...
        <form method="POST" action="/exams/{{ $exam->id }}">
            ...
            <div class="mb-8">
                <label class="block text-[12px] font-extrabold tracking-wider text-slate-700 uppercase mb-3">Select Questions For Quiz</label>
