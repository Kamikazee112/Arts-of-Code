    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="md:col-span-2">
            <div class="flex items-center gap-2 mb-4">
                ...
                <h3 class="text-[11.5px] uppercase tracking-[0.1em] text-[var(--muted)] font-bold">المقالات Authored</h3>
            </div>
            ...
            @else
                <div class="card p-8 text-center bg-slate-50/50 border-dashed border-slate-200">
                    ...
                    <h3 class="text-[14px] font-bold text-[var(--text)] mb-1">No المقالات Published</h3>
